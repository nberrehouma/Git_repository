...
public class GraphSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case GraphPackage.VERTEX: {
			...
			if (result == null)
				result = caseGraphElement(vertex);
			if (result == null)
				result = caseTyped(vertex);
			if (result == null)
				result = caseNamed(vertex);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case GraphPackage.EDGE: {
			...
			if (result == null)
				result = caseTyped(edge);
			if (result == null)
				result = caseNamed(edge);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case GraphPackage.LABEL: {
			...
			if (result == null)
				result = caseNamed(label);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case GraphPackage.ENTRY: {
		...
		case GraphPackage.GRAPH_ELEMENT: {
			...
			if (result == null)
				result = caseTyped(graphElement);
			if (result == null)
				result = caseNamed(graphElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
